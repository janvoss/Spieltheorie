...
geom_text(x=-1  , y= 3.3 , label='left')+\
geom_text(x= 1  , y= 3.3 , label='right')+\
geom_text(x=-2.2, y= 1.375, angle=90, label='top')+\
geom_text(x=-2.2, y=-1.625, angle=90, label='bottom')+\
geom_text(x= 0 , y= 4 ,
          fontface = "bold", label='Player 2')+\
geom_text(x=-2.7 , y= 0 , angle=90,
          fontface = "bold", label='Player 1')+\
