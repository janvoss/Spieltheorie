...
def create_plot(a, A, b, B, c, C, d, D, Aufgabe):
    LetsPlot.setup_html()
    return (
        ggplot() +
        ...
        geom_segment(x=2 , xend=2 , y=-3 , yend=3) +
        theme_void() +
        labs(title=f'Auszahlungen Aufgabe {Aufgabe}')
    )
...
for i in range(10):
    ...
    p = create_plot(a, A, b, B, c, C, d, D, Aufgabe)
...
results_df.columns=["Aufgabe", "Nash GG","p_l", "p_o"]
